...
{
    /// <summary>
    /// This class is designed to perform fraction math
    /// It defines a class fraction that has two member  fields
    /// numerator and denominator
    /// it overrides the math operators 
    /// +, -, *, /, ==, !=, Equals(), >, <, >=, <=
    /// It also contains methods for getting the greatest common
    /// denominator and for reducing a fraction
    /// </summary>
